...
| --- | --- |
| [features.md](features.md) | Product features, routes, and user workflows |
| [product-development-plan.md](../product-development-plan.md) | Roadmap and planned capabilities |

## Build and operate

| Document | Description |
| --- | --- |
| [getting-started.md](getting-started.md) | Install, OAuth, database, FastAPI, troubleshooting, production |
